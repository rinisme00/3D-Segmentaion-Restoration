# ============================================================================ #
# PTv3-Base — Fantastic Breaks Binary Classification
...
# misc
batch_size = 8   # smaller batch for Base (heavier model on RTX 3090)
num_worker = 4
batch_size_val = 8
empty_cache = False
enable_amp = True
...
model = dict(
    ...
    backbone=dict(
        ...
        stride=(2, 2, 2, 2),
        enc_depths=(2, 2, 2, 6, 2),            # ← deeper middle stage
        enc_channels=(32, 64, 128, 256, 512),   # ← wider channels
        ...
        attn_drop=0.0,
        proj_drop=0.0,
        drop_path=0.3,             # higher drop_path to combat overfitting
        shuffle_orders=True,
        pre_norm=True,
        enable_rpe=False,
        enable_flash=True,
