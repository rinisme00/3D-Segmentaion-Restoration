# ============================================================================ #
# PTv3-Small — Breaking Bad Pretrain (Binary Classification)
# Classes: 0=complete, 1=broken | ~636 train / ~160 test
...
# ── Dataset ──────────────────────────────────────────────────────────────────
dataset_type = "BreakingBadClsDataset"
...
data = dict(
    ...
    train=dict(
        ...
        test_mode=False,
        loop=2,  # BB is larger, less oversampling needed
    ),
    val=dict(
        type=dataset_type,
        split="test",
